...
[![Codecov test coverage](https://codecov.io/gh/zhuxr11/RcppColMetric/graph/badge.svg)](https://app.codecov.io/gh/zhuxr11/RcppColMetric)
<!-- badges: end -->

The goal of RcppColMetric is to ...

## Installation

You can install the development version of RcppColMetric like so:
